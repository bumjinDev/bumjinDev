...
<p aligin="left">
  저는 대학교에서 컴퓨터 전공을 수료한 후, 국비 교육 과정을 통해 리눅스 서버와 네트워크 장비를 다루는 것에 매력을 느껴 필드 엔지니어로서 일하다가 근본적인 기술 개발, 버그 수정 등의 기술자로서 해야 할 업무가 매우 제한적이라고 느껴저 개발자로서의 커리어를 시작하였습니다.
