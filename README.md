...
### 회고가 아닌 시간 가치를 만들는 방식을 고지합니다.

<p align="left">
  Spring Boot 기반 바이오트 프로젝트가 가장 가장 현실적인 구조를 다루고 있고,<br>
  JWT, Redis, Jenkins, Docker, AWS 까지 적용하며 실용 구조에 다가가 배포 모델까지 가격적으로 구성하고 가체한 모델과 기본 구조에 대한 이해가 가장 강습니다.
</p>
