...
    </tr>
    <tr>
      <td align="center" width="-10px">wherehouse</td>
      <td align="center" width="-10px">2023.09.11 ~ <br>2024.04.01</td>
      <td>MZ 세대의 서울 내 거주지 선택 시 도움이<br>되기 위한 거주지 추천 서비스</td>
      <td align="center">
        [ 1차 프로젝트 - UI ]
        <div align="left">KakaoMap API를 적용 하여<br>사용자 임의 핀 포인트 적용 시<br>반경 500M 내 CCTV 마커 생성.</div><br>[ 2차 프로젝트 - Servlet ]
        <div align="left">게시판 및 회원 가입 기능 구현.</div><br>[ 3차 프로젝트 - Spring ]<div align="left">기존 거주지 추천 페이지와 지역구 지도 페이지 및 회원 가입 및 게시판 기능을 Spring 으로 변환.</div><br>
      </td>
